...
Future work should also formally align the resulting schema with relevant metadata standards and application-profile practices, introduce normalized value representations and controlled vocabularies where appropriate, and investigate machine-readable implementations and richer relational structures.
...
\section{Appendix: Schema Validation 2 and 3 results}
\label{appendix:tbd}

[TODO: Create an appendix for the observed results between Schema Validation 2 and 3 where the shift in schema format, from Markdown to JSON, resulted into substantially more raised gaps.]
