...
Metadata profile development, schema discovery, ontology learning, and multimodal document understanding provide complementary foundations for this task~\citep{coyle2009applicationprofiles,sadruddin2025schemadiscovery,giglou2023llms4ol,ding2026vrdu}. These areas contribute methods for defining operational metadata terms, discovering and consolidating candidate concepts, and interpreting visually rich artifacts. The present work adapts and integrates these methods for a setting in which multimodal artifacts supply the initial evidence and an operational metadata schema is the required endpoint.
...
\begin{enumerate}
    \item an artifact-driven methodology that adapts and integrates established methods from metadata profile development, schema discovery, ontology learning, and multimodal document understanding to derive an operational metadata schema from the artifacts it must describe;
