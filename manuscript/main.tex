...
\begin{figure}[!ht]
    ...
    \caption{The development workflow transforms the 210 development snapshots into the Data Snapshot Metadata Schema through explicit intermediate knowledge artifacts. Colors distinguish LLM-supported, deterministic, and human-guided transformations. [TODO: Update the stage and artifact labels to use the metadata-concept-inventory terminology.]}
