...
\begin{figure}[!ht]
    ...
    \caption{The complete development workflow transforms 210 development snapshots through the six development stages into an initial 36-field schema, evaluates it against 202 held-out snapshots, and applies standards-informed refinement to produce the final 37-field Data Snapshot Metadata Schema. Colors distinguish LLM-supported, deterministic, and human-guided transformations. [TODO: Add standards-informed schema refinement and the final standards-informed schema.]}
